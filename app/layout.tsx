...
export const metadata: Metadata = {
  title: "Budget-Constrained AI-Based Interior Design Recommendation System",
  description:
    "MSc-level AI interior design system with offline local GPU support, budget estimation, and multiple provider options.",
  keywords: [
    "interior design",
    "AI",
    "home design",
